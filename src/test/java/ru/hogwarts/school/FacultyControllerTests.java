...
public class FacultyControllerTests {
    ...
    @Test
    public void testFindByNameAndColorIngnoreCase() throws Exception {
        ...
        when(facultyRepository.findByNameIgnoreCaseOrColorIgnoreCase(name, color)).thenReturn(facultyCollection);
...
//when(facultyRepository.findFacultyByStudentsIsContaining(any(Student.class))).thenReturn(id);
//        this.mockMvc.perform(MockMvcRequestBuilders //Get Faculty By Student
//                        .get("/faculty/{student}", student)
//                        .accept(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.color").value(color));
    }
